...
$sendToEmail = 'mfphotos@vastwavedigital.com';
$sendToName = 'MF Photos';
...
try
{
    ...
    $emailTextHtml .= "<h3>New message from the MF Photos:</h3><hr>";
    $emailTextHtml .= "<table>";
    ...
    $emailTextHtml .= "<p>Have a great day!<br><br>Sincerely,<br><br>MF Photos</p>";
